...
public abstract class MixinDolphinEntity extends WaterCreatureEntity {
    protected MixinDolphinEntity(EntityType<? extends WaterCreatureEntity> entityType, World world) {
